...
export type GetCompareLaunchesQuery = { __typename?: 'Query', launch1?: { __typename?: 'Launch', id?: string | null, launch_success?: boolean | null, static_fire_date_unix?: any | null, tentative_max_precision?: string | null, mission_name?: string | null, rocket?: { __typename?: 'LaunchRocket', rocket_name?: string | null, rocket_type?: string | null, first_stage?: { __typename?: 'LaunchRocketFirstStage', cores?: Array<{ __typename?: 'LaunchRocketFirstStageCore', land_success?: boolean | null } | null> | null } | null, second_stage?: { __typename?: 'LaunchRocketSecondStage', payloads?: Array<{ __typename?: 'Payload', payload_type?: string | null, payload_mass_kg?: number | null } | null> | null } | null } | null } | null, launch2?: { __typename?: 'Launch', id?: string | null, launch_success?: boolean | null, static_fire_date_unix?: any | null, tentative_max_precision?: string | null, mission_name?: string | null, rocket?: { __typename?: 'LaunchRocket', rocket_name?: string | null, rocket_type?: string | null, first_stage?: { __typename?: 'LaunchRocketFirstStage', cores?: Array<{ __typename?: 'LaunchRocketFirstStageCore', land_success?: boolean | null } | null> | null } | null, second_stage?: { __typename?: 'LaunchRocketSecondStage', payloads?: Array<{ __typename?: 'Payload', payload_type?: string | null, payload_mass_kg?: number | null } | null> | null } | null } | null } | null };
...
export const GetAllLaunchesDocument = `
  ...
  launchesPast(limit: 10, offset: $offset) {
    ...
    `;
export const useGetAllLaunchesQuery = <
      TData = GetAllLaunchesQuery,
      TError = unknown
    >(
      client: GraphQLClient,
      variables?: GetAllLaunchesQueryVariables,
      options?: UseQueryOptions<GetAllLaunchesQuery, TError, TData>,
...
export const useInfiniteGetAllLaunchesQuery = <
      TData = GetAllLaunchesQuery,
      TError = unknown
    >(
    ...
    useInfiniteQuery<GetAllLaunchesQuery, TError, TData>(
      ...
      (metaData) => fetcher<GetAllLaunchesQuery, GetAllLaunchesQueryVariables>(client, GetAllLaunchesDocument, {...variables, ...(metaData.pageParam ? {[pageParamKey]: metaData.pageParam} : {})}, headers)(),
      options
    );
...
export const GetLaunchesByMissionNameDocument = `
  ...
  missions(find: {name: $name}, limit: 5) {
    ...
    `;
export const useGetLaunchesByMissionNameQuery = <
      TData = GetLaunchesByMissionNameQuery,
      TError = unknown
    >(
      client: GraphQLClient,
      variables?: GetLaunchesByMissionNameQueryVariables,
      options?: UseQueryOptions<GetLaunchesByMissionNameQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useQuery<GetLaunchesByMissionNameQuery, TError, TData>(
      variables === undefined ? ['GetLaunchesByMissionName'] : ['GetLaunchesByMissionName', variables],
      fetcher<GetLaunchesByMissionNameQuery, GetLaunchesByMissionNameQueryVariables>(client, GetLaunchesByMissionNameDocument, variables, headers),
      options
    );
export const useInfiniteGetLaunchesByMissionNameQuery = <
      TData = GetLaunchesByMissionNameQuery,
      TError = unknown
    >(
      pageParamKey: keyof GetLaunchesByMissionNameQueryVariables,
      client: GraphQLClient,
      variables?: GetLaunchesByMissionNameQueryVariables,
      options?: UseInfiniteQueryOptions<GetLaunchesByMissionNameQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useInfiniteQuery<GetLaunchesByMissionNameQuery, TError, TData>(
      variables === undefined ? ['GetLaunchesByMissionName.infinite'] : ['GetLaunchesByMissionName.infinite', variables],
      (metaData) => fetcher<GetLaunchesByMissionNameQuery, GetLaunchesByMissionNameQueryVariables>(client, GetLaunchesByMissionNameDocument, {...variables, ...(metaData.pageParam ? {[pageParamKey]: metaData.pageParam} : {})}, headers)(),
      options
    );

export const GetCompareLaunchesDocument = `
  ...
  launch2: launch(id: $id2) {
    ...
    `;
export const useGetCompareLaunchesQuery = <
      TData = GetCompareLaunchesQuery,
      TError = unknown
    >(
      client: GraphQLClient,
      variables: GetCompareLaunchesQueryVariables,
      options?: UseQueryOptions<GetCompareLaunchesQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useQuery<GetCompareLaunchesQuery, TError, TData>(
      ['GetCompareLaunches', variables],
      fetcher<GetCompareLaunchesQuery, GetCompareLaunchesQueryVariables>(client, GetCompareLaunchesDocument, variables, headers),
      options
    );
export const useInfiniteGetCompareLaunchesQuery = <
      TData = GetCompareLaunchesQuery,
      TError = unknown
    >(
      pageParamKey: keyof GetCompareLaunchesQueryVariables,
      client: GraphQLClient,
      variables: GetCompareLaunchesQueryVariables,
      options?: UseInfiniteQueryOptions<GetCompareLaunchesQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useInfiniteQuery<GetCompareLaunchesQuery, TError, TData>(
      ['GetCompareLaunches.infinite', variables],
      (metaData) => fetcher<GetCompareLaunchesQuery, GetCompareLaunchesQueryVariables>(client, GetCompareLaunchesDocument, {...variables, ...(metaData.pageParam ? {[pageParamKey]: metaData.pageParam} : {})}, headers)(),
      options
    );
